...
type ProductQueryServiceClient interface {
	GetProduct(ctx context.Context, in *wrappers.StringValue, opts ...grpc.CallOption) (*model.Product, error)
...
func (c *productQueryServiceClient) GetProduct(ctx context.Context, in *wrappers.StringValue, opts ...grpc.CallOption) (*model.Product, error) {
...
func (c *productQueryServiceClient) GetAllProducts(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductQueryServiceServer interface {
	GetProduct(context.Context, *wrappers.StringValue) (*model.Product, error)
...
func (UnimplementedProductQueryServiceServer) GetProduct(context.Context, *wrappers.StringValue) (*model.Product, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProduct not implemented")
}
func (UnimplementedProductQueryServiceServer) GetAllProducts(context.Context, *empty.Empty) (*GetAllProductsResponse, error) {
...
func _ProductQueryService_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductQueryServiceServer).GetProduct(ctx, req.(*wrappers.StringValue))
	}
...
func _ProductQueryService_GetAllProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductQueryServiceServer).GetAllProducts(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
type ProductCommandServiceClient interface {
	...
	DeleteProduct(ctx context.Context, in *wrappers.StringValue, opts ...grpc.CallOption) (*wrappers.BoolValue, error)
}
...
func (c *productCommandServiceClient) DeleteProduct(ctx context.Context, in *wrappers.StringValue, opts ...grpc.CallOption) (*wrappers.BoolValue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductCommandServiceServer interface {
	...
	DeleteProduct(context.Context, *wrappers.StringValue) (*wrappers.BoolValue, error)
...
func (UnimplementedProductCommandServiceServer) DeleteProduct(context.Context, *wrappers.StringValue) (*wrappers.BoolValue, error) {
...
func _ProductCommandService_DeleteProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductCommandServiceServer).DeleteProduct(ctx, req.(*wrappers.StringValue))
	}
	return interceptor(ctx, in, info, handler)
}
