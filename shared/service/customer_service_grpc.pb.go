...
type CustomerQueryServiceClient interface {
	GetCustomer(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*model.Customer, error)
	GetAllCustomers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllCustomersResponse, error)
}
...
func (c *customerQueryServiceClient) GetCustomer(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*model.Customer, error) {
...
func (c *customerQueryServiceClient) GetAllCustomers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllCustomersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CustomerQueryServiceServer interface {
	GetCustomer(context.Context, *wrapperspb.StringValue) (*model.Customer, error)
	GetAllCustomers(context.Context, *emptypb.Empty) (*GetAllCustomersResponse, error)
...
func (UnimplementedCustomerQueryServiceServer) GetCustomer(context.Context, *wrapperspb.StringValue) (*model.Customer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCustomer not implemented")
}
func (UnimplementedCustomerQueryServiceServer) GetAllCustomers(context.Context, *emptypb.Empty) (*GetAllCustomersResponse, error) {
...
func _CustomerQueryService_GetCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerQueryServiceServer).GetCustomer(ctx, req.(*wrapperspb.StringValue))
	}
...
func _CustomerQueryService_GetAllCustomers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerQueryServiceServer).GetAllCustomers(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
type CustomerCommandServiceClient interface {
	...
	DeleteCustomer(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error)
}
...
func (c *customerCommandServiceClient) DeleteCustomer(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CustomerCommandServiceServer interface {
	...
	DeleteCustomer(context.Context, *wrapperspb.StringValue) (*wrapperspb.BoolValue, error)
...
func (UnimplementedCustomerCommandServiceServer) DeleteCustomer(context.Context, *wrapperspb.StringValue) (*wrapperspb.BoolValue, error) {
...
func _CustomerCommandService_DeleteCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerCommandServiceServer).DeleteCustomer(ctx, req.(*wrapperspb.StringValue))
	}
	return interceptor(ctx, in, info, handler)
}
