...
func Init(port string) {
	...
	service.RegisterOrderQueryServiceServer(grpcServer, &repository.GrpcQueryService{})
	service.RegisterOrderCommandServiceServer(grpcServer, &repository.GrpcCommandService{})
