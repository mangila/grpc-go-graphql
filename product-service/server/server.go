...
func Init(port string) {
	...
	service.RegisterProductQueryServiceServer(grpcServer, &repository.GrpcQueryService{})
	service.RegisterProductCommandServiceServer(grpcServer, &repository.GrpcCommandService{})
	logger.Logger.Infof("order-service running on port: %v", port)
